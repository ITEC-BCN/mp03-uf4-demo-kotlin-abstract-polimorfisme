...
/**
 * Classe de patro singleton. Vol dir que nomes es podra crear un unic objecte de la classe.
 * Podrem usar els seus metodes com si fossin statics.
 * Proposit: demo del model de dades creat.
 * @author RIS
 */
object DemoFuncionalitats {
    fun main() {
        ...
        var c1: Cercle = Cercle(10.0, 10.0, "blanc", 5.0)
        var c2: Cercle = Cercle(20.0, 20.0, "lila", 10.0)
        var t1: Triangle = Triangle(30.0, 30.0, "groc", 10.0, 5.0)
        var t2: Triangle = Triangle(40.0, 40.0, "blau", 20.0, 10.0)
        var p1: Pentagon = Pentagon(20.0, 20.0, "verd", 13.2)
        ...
        var o1: ObjecteGeometric = Triangle(60.0, 60.0, "vermell", 25.0, 15.0)
        println(o1)
